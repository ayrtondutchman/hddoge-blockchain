...
from hddoge.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "hddoge" in cc_discrepancies:
                    cc_discrepancies["hddoge"] = cc_discrepancies["hddoge"] + diff
                else:
                    cc_discrepancies["hddoge"] = diff
