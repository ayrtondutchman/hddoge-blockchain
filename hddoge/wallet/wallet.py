...
from hddoge.consensus.cost_calculator import calculate_cost_of_program, NPCResult
from hddoge.full_node.bundle_tools import simple_solution_generator
...
from hddoge.types.announcement import Announcement
...
from hddoge.wallet.puzzles.p2_delegated_puzzle_or_hidden_puzzle import (
    DEFAULT_HIDDEN_PUZZLE_HASH,
    calculate_synthetic_secret_key,
    puzzle_for_pk,
    solution_for_conditions,
)
from hddoge.wallet.puzzles.puzzle_utils import (
...
from hddoge.wallet.secret_key_store import SecretKeyStore
from hddoge.wallet.sign_coin_solutions import sign_coin_solutions
...
from hddoge.wallet.wallet_info import WalletInfo
...
class Wallet:
    ...
    async def create_spend_bundle_relative_hddoge(self, hddoge_amount: int, exclude: List[Coin]) -> SpendBundle:
        list_of_solutions = []
        utxos = None
        ...
        if hddoge_amount < 0:
            utxos = await self.select_coins(abs(hddoge_amount), exclude)
        else:
        ...
        hddoge_amount = spend_value + hddoge_amount
        ...
        for coin in utxos:
            ...
            if output_created is None:
                ...
                primaries = [{"puzzlehash": newpuzhash, "amount": hddoge_amount}]
