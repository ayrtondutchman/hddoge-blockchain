...
from hddoge.util.keychain import Keychain, bytes_to_mnemonic, generate_mnemonic
...
def generate_and_print():
    ...
    print(mnemonic)
    print("Note that this key has not been added to the keychain. Run hddoge keys add")
    return mnemonic
...
def show_all_keys(show_mnemonic: bool):
    ...
    for sk, seed in private_keys:
        ...
        print(
            "Farmer public key (m/12381/6969/0/0):",
            master_sk_to_farmer_sk(sk).get_g1(),
        )
        print("Pool public key (m/12381/6969/1/0):", master_sk_to_pool_sk(sk).get_g1())
        print(
        ...
        if show_mnemonic:
            ...
            print(
                "First wallet secret key (m/12381/6969/2/0):",
