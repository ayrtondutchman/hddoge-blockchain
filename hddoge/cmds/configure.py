...
from hddoge.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "69420"
            testnet_introducer = "beta1_introducer.hddoge.org"
            testnet = "testnet7"
    ...
    if change_made:
        print("Restart any running hddoge services for changes to take effect")
