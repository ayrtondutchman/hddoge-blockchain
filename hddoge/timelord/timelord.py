...
from hddogevdf import create_discriminant

from hddoge.consensus.constants import ConsensusConstants
from hddoge.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from hddoge.timelord.iters_from_block import iters_from_block
from hddoge.timelord.timelord_state import LastState
from hddoge.timelord.types import Chain, IterationType, StateType
from hddoge.types.blockchain_format.classgroup import ClassgroupElement
from hddoge.types.blockchain_format.reward_chain_block import RewardChainBlock
...
class Timelord:
    def __init__(self, root_path, config: Dict, constants: ConsensusConstants):
        ...
        self.server: Optional[HddogeServer] = None
