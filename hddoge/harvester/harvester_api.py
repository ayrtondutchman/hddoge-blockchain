...
from hddoge.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from hddoge.harvester.harvester import Harvester
from hddoge.plotting.plot_tools import PlotInfo, parse_plot_info
from hddoge.protocols import harvester_protocol
from hddoge.protocols.farmer_protocol import FarmingInfo
from hddoge.protocols.protocol_message_types import ProtocolMessageTypes
from hddoge.server.outbound_message import make_msg
...
from hddoge.util.api_decorators import api_request, peer_required
from hddoge.util.ints import uint8, uint32, uint64
from hddoge.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSHddogeConnection
    ):
        """
