...
from hddoge.cmds.init_funcs import check_keys
from hddoge.consensus.block_rewards import calculate_base_farmer_reward
from hddoge.protocols.protocol_message_types import ProtocolMessageTypes
from hddoge.server.outbound_message import NodeType, make_msg
...
from hddoge.util.keychain import bytes_to_mnemonic, generate_mnemonic
from hddoge.util.path import path_from_root
from hddoge.util.ws_message import WsRpcMessage, create_payload_dict
...
from hddoge.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from hddoge.wallet.util.trade_utils import trade_record_to_dict
...
from hddoge.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "hddoge_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "hddoge_wallet", "wallet_ui")]
