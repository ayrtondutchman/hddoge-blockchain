...
import { AlertDialog, Flex, Card } from '@hddoge/core';
...
import { mojo_to_hddoge_string, hddoge_to_mojo } from '../../../util/hddoge';
  ...
  return (
    <Grid item xs={12}>
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {mojo_to_hddoge_string(props.balance)} {currencyCode}
          </Typography>
        </Box>
      </Box>
    </Grid>
  ...
  return (
    <Card title={<Trans>Balance</Trans>}>
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the total amount of hddoge in the blockchain at the current
      ...
      <BalanceCardSubSection
        ...
        tooltip={
          <Trans>
            This is the amount of Hddoge that you can currently use to make
            transactions. It does not include pending farming rewards, pending
            incoming transactions, and Hddoge that you have just spent but is not
...
function SendCard(props: SendCardProps) {
  ...
  function send() {
    ...
    const amount = hddoge_to_mojo(amount_input.value);
    const fee = hddoge_to_mojo(fee_input.value);
    ...
    if (address.includes('colour')) {
      dispatch(
        openDialog(
          <AlertDialog>
            <Trans>
              Error: Cannot send hddoge to coloured address. Please enter a hddoge
              address.
            </Trans>
          </AlertDialog>,
        ),
    ...
    if (address.slice(0, 12) === 'hddoge_addr://') {
