...
import { Card, CopyToClipboard, Flex, Table } from '@hddoge/core';
import type { RootState } from '../../modules/rootReducer';
import type { Row } from '../core/components/Table/Table';
import { mojo_to_hddoge_string, mojo_to_colouredcoin_string } from '../../util/hddoge';
...
const getCols = (type: WalletType) => [
  ...
  },
  {
    field: (row: Row) => type === WalletType.COLOURED_COIN
      ...
      : mojo_to_hddoge_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => mojo_to_hddoge_string(row.fee_amount),
