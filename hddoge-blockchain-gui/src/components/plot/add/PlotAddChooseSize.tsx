...
import { CardStep, ConfirmDialog, Link, Select, StateColor } from '@hddoge/core';
    ...
    >
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/Ayrtondutchman/hddoge-blockchain/wiki/k-sizes">Learn more</Link>
        </Trans>
      </Typography>
