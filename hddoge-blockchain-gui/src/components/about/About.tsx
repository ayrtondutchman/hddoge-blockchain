...
import icon from '../../assets/img/hddoge_circle.svg';
    ...
    <html>
      ...
      <body>
        ...
        <div className="copyright">
          Copyright (c) 2021 Hddoge Network
        </div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
        ...
        <BugReport href="https://github.com/Hddoge-Network/hddoge-blockchain/issues" target="_blank">
          Report an issue
        </BugReport>
        {'{{CSS}}'}
      </body>
