...
describe("units", () => {
  describe("#getUnit", () => {
    it("gets unit of hddoge", () => {
      const result = units.getUnit("hddoge");
    ...
    it("gets unit of hddoge using alias", () => {
  ...
  describe("#setUnit", () => {
    ...
    it("modifies an existing unit", () => {
      units.setUnit("hddoge", 9);

      const result = units.getUnit("hddoge");

      expect(result).toEqual(9);

      units.setUnit("hddoge", 1);
    });
  });
  describe("#setDisplay", () => {
