...
function getInstallerConfig () {
  ...
  return Promise.resolve({
    appDirectory: path.join(rootPath, 'Hddoge-win32-x64'),
    ...
    exe: 'Hddoge.exe',
    setupExe: 'HddogeSetup-' + process.env.HDDOGE_INSTALLER_VERSION + '.exe',
    setupIcon: path.join(rootPath, 'src', 'assets', 'img', 'hddoge.ico')
  })
}
