...
````bash
~/.hddoge/<currentversion>/config/ssl/daemon/private_daemon.crt
~/.hddoge/<currentversion>/config/ssl/daemon/private_daemon.key
````
...
````bash
~/.hddoge/<currentversion>/config/ssl/ui/
~/.hddoge/<currentversion>/config/ssl/ui/
````
