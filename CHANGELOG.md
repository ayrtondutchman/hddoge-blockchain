...
- Mainnet uses port 6969 and other constants and service names were changed for mainnet.
...
- Testnet is now running at the primary port of 49126. Update your routers appropriately. This opens 6969 for mainnet.
...
- Introducer now makes sure it only sends peer addresses to peers of peers that it can reach on port 6969 or their UPnP port.
