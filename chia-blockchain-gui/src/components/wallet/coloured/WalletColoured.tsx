...
import {
  pupps_to_colouredcoin_string,
  colouredcoin_to_pupps,
} from '../../../util/chia';
      ...
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {pupps_to_colouredcoin_string(props.balance)} {cc_unit}
          </Typography>
        </Box>
      </Box>
    </Grid>
...
function BalanceCard(props: BalanceCardProps) {
  ...
  const balance_ptotal_chia = pupps_to_colouredcoin_string(balance_ptotal);
  const balance_pending_chia = pupps_to_colouredcoin_string(balance_pending);
  const balance_change_chia = pupps_to_colouredcoin_string(balance_change);
  const acc_content =
    balancebox_1 +
    balancebox_2 +
    balancebox_ptotal +
...
function SendCard(props: SendCardProps) {
  ...
  function send() {
    ...
    const amount = colouredcoin_to_pupps(amount_input.value);
    const fee = colouredcoin_to_pupps(fee_input.value);
