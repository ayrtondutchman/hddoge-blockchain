...
from hddoge.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "hddoge/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "hddoge/wallet/puzzles/cc.clvm",
        "hddoge/wallet/puzzles/hddogelisp_deserialisation.clvm",
        "hddoge/wallet/puzzles/rom_bootstrap_generator.clvm",
        "hddoge/wallet/puzzles/generator_for_single_coin.clvm",
        "hddoge/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "hddoge/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "hddoge/wallet/puzzles/lock.inner.puzzle.clvm",
        "hddoge/wallet/puzzles/p2_conditions.clvm",
        "hddoge/wallet/puzzles/p2_delegated_conditions.clvm",
        "hddoge/wallet/puzzles/p2_delegated_puzzle.clvm",
        "hddoge/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "hddoge/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "hddoge/wallet/puzzles/p2_puzzle_hash.clvm",
        "hddoge/wallet/puzzles/rl_aggregation.clvm",
        "hddoge/wallet/puzzles/rl.clvm",
        "hddoge/wallet/puzzles/sha256tree_module.clvm",
        "hddoge/wallet/puzzles/singleton_top_layer.clvm",
        "hddoge/wallet/puzzles/did_innerpuz.clvm",
        "hddoge/wallet/puzzles/decompress_puzzle.clvm",
        "hddoge/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "hddoge/wallet/puzzles/decompress_coin_solution_entry.clvm",
        "hddoge/wallet/puzzles/block_program_zero.clvm",
        "hddoge/wallet/puzzles/test_generator_deserialize.clvm",
        "hddoge/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
    ]
)

clvm_include_files = set(
    ["hddoge/wallet/puzzles/create-lock-puzzlehash.clvm", "hddoge/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "hddoge/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to hddoge/wallet/puzzles, but not added to `wallet_program_files`
        """
