...
from hddoge.protocols.full_node_protocol import RespondBlock
from hddoge.server.server import HddogeServer
from hddoge.simulator.simulator_protocol import FarmNewBlockProtocol, ReorgProtocol
...
class TestWalletSimulator:
    ...
    #         outbound: List[WSHddogeConnection] = wallet.server.get_outgoing_connections()
