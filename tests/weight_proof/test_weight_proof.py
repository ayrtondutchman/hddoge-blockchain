...
from hddoge.consensus.blockchain import Blockchain
...
from hddoge.server.start_full_node import SERVICE_NAME
...
from hddoge.consensus.pot_iterations import calculate_iterations_quality
from hddoge.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
